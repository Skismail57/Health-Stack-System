...
"""
Security hardening: removed CSRF exemptions. Templates include csrf tokens,
so default CSRF protection is now enforced for POST endpoints.
"""
...
def hospital_home(request):
    ...
    # Database updated with correct hospital name, no renaming needed
